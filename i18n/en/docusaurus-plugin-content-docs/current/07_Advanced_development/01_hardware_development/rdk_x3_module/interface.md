...
2. Use the official burning tool `hbupdate` to update the core board's startup firmware. For specific methods, please refer to [Image Burning](../../../01_Quick_start/install_os/rdk_x3_module/01_system_burn.md).

...
See [Flashing with RDK Studio](https://developer.d-robotics.cc/rdk_studio_doc/category/2-quick-start).
...
At **Select storage device**, choose the USB drive. See [Flashing with RDK Studio](https://developer.d-robotics.cc/rdk_studio_doc/category/2-quick-start).

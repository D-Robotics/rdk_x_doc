...
For fusion applications such as stereo IMU cameras, see [Stereo IMU Camera](https://developer.d-robotics.cc/tros_doc/en/boxs/spatial/stereo_imu_cam?v=3.5.0&p=RDK+X5).

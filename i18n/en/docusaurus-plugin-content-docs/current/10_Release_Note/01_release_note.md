...
- Added [ASR open-source solution](../05_Robot_development.md) based on `sensevoice_cpp`, supporting command words and ASR data push.
- [Stereo depth estimation algorithm](../05_Robot_development.md) optimized post-processing time, added V2.3 model.
- Added [vision-language model](../05_Robot_development.md) demo based on `llama.cpp`.

#### Version: 2.3.2 (2025-01-15)

**Feature Changes:**

- [Stereo depth estimation algorithm](../05_Robot_development.md) updated stereo model, improved depth estimation.
- [Multi-channel video analysis](../05_Robot_development.md) demo optimized processing and web visualization.
- [StereoNet utility package](https://github.com/D-Robotics/hobot_stereonet_utils) removed some non-startable launch files.

**New Features:**

- Added [ZED camera image acquisition](../05_Robot_development.md) for stereo image input.
- Added [DOSOD algorithm](../05_Robot_development.md), providing open-vocabulary detection on edge devices.

**Bug Fixes:**

- Fixed [yolov8-seg image segmentation](../05_Robot_development.md) post-processing box out-of-bounds crash.
- [Image codec](../05_Robot_development.md) fixed frame rate statistics error.
- [Stereo MIPI image acquisition](../05_Robot_development.md) fixed i2c detection, added lpwm switch config.
...
- [Image publisher tool](../05_Robot_development.md) supports `bgr/rgb` message publishing and frame_id config.
- [Human detection and tracking](../05_Robot_development.md) supports topic config, component mode, image scaling, compressed image playback, etc.
...
- [Image codec Node](../05_Robot_development.md) supports frame_id passing and frame drop control.
- [Gesture recognition](../05_Robot_development.md) supports post-processing threshold config and dynamic gesture recognition.
- Added [face age detection](../05_Robot_development.md).
- Added [face 106 landmark detection](../05_Robot_development.md).
...
- Added [multi-channel video analysis](../05_Robot_development.md) demo.

**Bug Fixes:**

- [MIPI image acquisition](../05_Robot_development.md) fixed `imx219` module startup failure.
- [Hand landmark detection](../05_Robot_development.md) improved hand box expansion and keypoint output.
...
- Data acquisition adds [Stereo MIPI image acquisition](../05_Robot_development.md).
- Algorithm repo adds `yolov8`, `yolov10` [object detection](../05_Robot_development.md), `yolov8-seg` [image segmentation](../05_Robot_development.md).
- Added [YOLO-World](../05_Robot_development.md), [optical flow estimation](../05_Robot_development.md), [segment anything](../05_Robot_development.md), [text-image feature retrieval](../05_Robot_development.md), [stereo depth estimation](../05_Robot_development.md).

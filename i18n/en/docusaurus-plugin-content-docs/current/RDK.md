...
**D-Robotics Developer Kits** (RDK Suite) are developer kits based on D-Robotics intelligent chips. The hardware portfolio includes:
...
**4. Model Zoo**  
Introduces the RDK Model Zoo and how to quickly deploy heterogeneous models on the board.

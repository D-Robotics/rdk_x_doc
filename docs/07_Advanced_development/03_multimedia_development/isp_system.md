...
定义 AE 统计数据结构体。有关 AE 统计数据详细描述可见[统计信息](#ae-统计信息)章节。
...
定义 AWB 统计数据结构体。有关 AWB 统计数据详细描述可见[统计信息](#awb-统计信息)章节。
...
定义 AF 统计数据结构体。有关 AF 统计数据详细描述可见[统计信息](#af-统计信息)章节。
...
| 其他成员 | 统计数据的范围，见[1.14.1](#awb-统计信息)节描述  取值：[0,4095] |
